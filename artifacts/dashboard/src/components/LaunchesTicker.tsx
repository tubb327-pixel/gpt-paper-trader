...
export function LaunchesTicker() {
  ...
  return (
    <div
      className="bg-[#12121a] border-b border-[#1f1f2e] h-12 overflow-hidden relative flex-shrink-0"
    ...
    >
      ...
      <div
        ...
        style={{
          animation: paused || tiles.length === 0
            ? "none"
      ...
      >
        {tiles.length === 0 ? (
          ...
          tiles.map((l, i) => {
            ...
            const colorClass = arch && arch !== "unknown"
            ...
            return (
              ...
              >
                ...
                {arch && arch !== "unknown" && (
                  <span className="text-[9px] opacity-70">{arch.replace(/_/g, " ")}</span>
                )}
              </a>
            );
          })
